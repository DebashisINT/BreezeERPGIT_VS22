...
namespace Payroll.Controllers
{
    public class payLoginController : Controller
    {
        ...
        public JsonResult login(string user_id, string password)
        {
            ...
            Session["ErpConnection"] = @"Data Source=3.7.30.86,1480\SQLEXPRESS;Initial Catalog=Amith_27072021;User ID=sa; Password=5dc57YITWh";
            ...
            BusinessLogicLayer.DBEngine oDBEngine = new BusinessLogicLayer.DBEngine(@"Data Source=3.7.30.86,1480\SQLEXPRESS;Initial Catalog=Amith_27072021;User ID=sa; Password=5dc57YITWh;pooling='true';Max Pool Size=200");
