...
{
    public partial class CustomerCrNoteAdjustmentList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable dtposTimeEdit = oDBEngine.GetDataTable("SELECT  top 1 convert(varchar(10),Lock_Fromdate,105) LockCon_Fromdate,convert(varchar(10),Lock_Todate,105) LockCon_Todate FROM Trans_LockConfigouration_Details WHERE  Type='Edit' and Module_Id=59");
            DataTable dtposTimeDelete = oDBEngine.GetDataTable("SELECT  top 1 convert(varchar(10),Lock_Fromdate,105) LockCon_Fromdate,convert(varchar(10),Lock_Todate,105) LockCon_Todate FROM Trans_LockConfigouration_Details WHERE  Type='Delete' and Module_Id=59");
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/Management/Activities/CustomerCrNoteAdjustmentList.aspx");
        ...
        protected void gridAdvanceAdj_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                int rowsNo = customerReceiptAdjustment.DeleteAdjForCrNote(param.Split('~')[1]);
                if (rowsNo > 0)
                {
        ...
        {
            gridAdvanceAdj.Columns[7].Visible = false;
            string filename = "Adjustment of Documents - Credit Notes";
            exporter.FileName = filename;
            exporter.FileName = "Adjustment of Documents - Credit Notes";
            exporter.PageHeader.Left = "Adjustment of Documents - Credit Notes";
