...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="JS/CustomerOnAccountAdjustment.js?var=2.1"></script>
    ...
    <div class="outer-div-main clearfix">
        ...
        <h3 class="pull-left">
            <asp:Label ID="lblHeading" runat="server" Text="Add Adjustment of Documents - Credit Note With Invoice"></asp:Label>
        </h3>
    </div>
        <div id="ApprovalCross" runat="server" class="crossBtn"><a href="CustomerCrNoteAdjustmentList.aspx"><i class="fa fa-times"></i></a></div>
        ...
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12" style="top: 20px;">
                        <dxe:ASPxGridView runat="server" ClientInstanceName="grid" ID="grid"
                            ...
                            KeyFieldName="SrlNo"
                            SettingsBehavior-AllowSort="false" Width="100%">
            ...
            <div class="clear"></div>
            <div class="row">
                <div class="col-md-12" style="margin-top: 40px; padding: 0 22px;">
