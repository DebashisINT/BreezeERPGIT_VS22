<%--==========================================================Revision History ============================================================================================   
   1.0   Priti   V2.0.36     16-01-2023   	0025323: Views to be converted to Procedures in the Listing Page of Transaction / Adjustment of Documents - Cu / Credit Note with Debit Note
========================================== End Revision History =======================================================================================================--%>


<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="CustomerCrNoteAdjustDrNoteList.aspx.cs" Inherits="ERP.OMS.Management.Activities.CustomerCrNoteAdjustDrNoteList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        function onEditClick(id) {
            window.location.href = 'CustomerCrNoteAdjustDrNote.aspx?Key=' + id;
        }
        ...
        function OnViewClick(keyValue) {
            var url = 'CustomerCrNoteAdjustDrNote.aspx?key=' + keyValue + '&req=V';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        <div class="panel-title clearfix">
            <h3 class="pull-left">Adjustment of Documents - Credit Note With Debit Note</h3>
        </div>
    </div>
    <table class="padTab">
        <tr>
    ...
    <div class="form_main">
     ...
     <div id="spnDeleteLock" runat="server" style="display:none; color:red;text-align:center"></div>
        ...
        <div class="GridViewArea relative">
            ...
            <dxe:ASPxGridView ID="gridAdvanceAdj" runat="server" KeyFieldName="CrDrAdj_id" AutoGenerateColumns="False"
                ...
                <Columns>
                    <dxe:GridViewDataTextColumn Visible="False" VisibleIndex="0" FieldName="CrDrAdj_id" Caption="CrDrAdj_id" SortOrder="Descending">
            ...
            <dx:LinqServerModeDataSource ID="EntityServerModeDataSource" runat="server" OnSelecting="EntityServerModeDataSource_Selecting"
                ContextTypeName="ERPDataClassesDataContext" TableName="v_CreditNoteAdjustmentDebitNote" />
