<%--=======================================================Revision History=====================================================    
    1.0   Pallab    V2.0.38   17-05-2023      0026158: Add Adjustment of Documents - Credit Note With Debit Note module design modification & check in small device
=========================================================End Revision History===================================================--%>

<%@ Page Title="CustomerCrNoteAdjustDrNote" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="CustomerCrNoteAdjustDrNote.aspx.cs" Inherits="ERP.OMS.Management.Activities.CustomerCrNoteAdjustDrNote" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="JS/CustCrNoteAdjustDrNote.js?var=1.9"></script>
    ...
    <div class="outer-div-main clearfix">
        ...
        <h3 class="pull-left">
            <asp:Label ID="lblHeading" runat="server" Text="Add Adjustment of Documents - Credit Note With Debit Note"></asp:Label>
        </h3>
    </div>
        <div id="ApprovalCross" runat="server" class="crossBtn"><a href="CustomerCrNoteAdjustDrNoteList.aspx"><i class="fa fa-times"></i></a></div>
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-2" id="divNumberingScheme" runat="server">
                        <label style="margin-top: 8px">Numbering Scheme<span style="color: red">*</span></label>
                        <div>
                            ...
                            <span id="MandatoryNumberingScheme" class="iconNumberScheme pullleftClass fa fa-exclamation-circle iconRed " style="color: red; position: absolute; right: -4px; top: 33px; display: none" title="Mandatory"></span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <div>
                            ...
                            <dxe:ASPxTextBox runat="server" ID="txtVoucherNo" ClientInstanceName="ctxtVoucherNo" MaxLength="16" Text="Auto">
                            </dxe:ASPxTextBox>

                            <span id="MandatoryAdjNo" class="voucherno  pullleftClass fa fa-exclamation-circle iconRed " style="color: red; position: absolute; right: -9px; top: 34px; display: none" title="Mandatory"></span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <div>
                            <dxe:ASPxDateEdit ID="dtTDate" runat="server" ClientInstanceName="cdtTDate" EditFormat="Custom" AllowNull="false"
                                ...
                                <ClientSideEvents GotFocus="function(s,e){cdtTDate.ShowDropDown();}" DateChanged="cAdjDateChange" LostFocus="function(s, e) { SetLostFocusonDemand(e)}"></ClientSideEvents>
                            </dxe:ASPxDateEdit>
                            <span id="MandatoryAdjDate" class="voucherno  pullleftClass fa fa-exclamation-circle iconRed " style="color: red; position: absolute; display: none" title="Mandatory"></span>
                        </div>
                        <%--Rev 1.0--%>
                    ...
                    <div class="col-md-2 lblmTop8 simple-select">
                        ...
                        <div>
                            ...
                            <span id="MandatoryBranch" class="iconBranch pullleftClass fa fa-exclamation-circle iconRed " style="color: red; position: absolute; right: -5px; top: 34px; display: none" title="Mandatory"></span>
                    ...
                    <div class="col-md-2 lblmTop8">
                        ...
                        <div>
                            ...
                            <span id="MandatoryCustomer" class="iconBranch pullleftClass fa fa-exclamation-circle iconRed " style="color: red; position: absolute; right: -5px; top: 34px; display: none" title="Mandatory"></span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 lblmTop8">
                        ...
                        <div>
                            <div>
                                ...
                                <span id="MandatoryDocNo" class="iconBranch pullleftClass fa fa-exclamation-circle iconRed " style="color: red; position: absolute; right: -5px; top: 35px; display: none" title="Mandatory"></span>
                            </div>
                        </div>
                    </div>
                    <div class="clear"></div>
                    ...
                    <div class="col-md-2 lblmTop8">
                        <label>Adj. Amount (Curr.)<span style="color: red">*</span></label>
                        <div>
                            <div>
    ...
    <div class="modal fade" id="AdvanceModel" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Credit Note Search</h4>
                </div>
                <div class="modal-body">
                    <div id="AdvRecDocTbl">
                        <table border='1' width="100%" class="dynamicPopupTbl">
    ...
    <asp:HiddenField ID="hdCrNoteType" runat="server" />
