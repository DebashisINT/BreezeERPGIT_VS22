<%--=======================================================Revision History=====================================================    
    1.0   Pallab    V2.0.38   17-05-2023      0026156: Add Adjustment of Documents - Advance With Invoice module design modification & check in small device
=========================================================End Revision History===================================================--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="CustomerReceiptAdjustment.aspx.cs" Inherits="ERP.OMS.Management.Activities.CustomerReceiptAdjustment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main clearfix">
        ...
        <h3 class="pull-left">
            <label>Add Adjustment of Documents - Advance With Invoice</label>
        </h3>
    </div>
        <div id="ApprovalCross" runat="server" class="crossBtn"><a href="CustomerReceiptAdjustmentList.aspx"><i class="fa fa-times"></i></a></div>
