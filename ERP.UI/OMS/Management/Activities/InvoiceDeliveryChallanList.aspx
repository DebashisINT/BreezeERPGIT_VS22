...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function OnEWayBillClick(id, VisibleIndex, EWayBillNumber, EWayBillDate, EWayBillValue) {
            ...
            $.ajax({
                type: "POST",
                url: "InvoiceDeliveryChallanList.aspx/EditEWayBill",
                data: JSON.stringify({
                    DocID: id
                }),
        ...
        function CallShipBill_save() {
            ...
            $.ajax({
                type: "POST",
                url: "InvoiceDeliveryChallanList.aspx/UpdateShipBillDet",
       ...
       if (cdt_EWayBill.GetValue() == "") 
       {
           jAlert("Please enter E-Way Bill Date.");
           return false;
       }
       else if (cdt_EWayBill.GetValue()==null)
       {

           jAlert("Please enter E-Way Bill Date.");
           return false;
       }
       else if (cdt_EWayBill.GetValue() == "01-01-0100") {
       ...
       $.ajax({
           type: "POST",
           url: "InvoiceDeliveryChallanList.aspx/UpdateEWayBill",
           data: JSON.stringify({
   ...
   function OnGetApprovedRowValues(obj) {
       uri = "InvoiceDeliveryChallan.aspx?key=" + obj + "&status=2" + '&type=SI';
   ...
   function OnGetRejectedRowValues(obj) {
       uri = "InvoiceDeliveryChallan.aspx?key=" + obj + "&status=3" + '&type=SI';
       popup.SetContentUrl(uri);
       popup.Show();
   }
   ...
   function OnApprovalEndCall(s, e) {
       $.ajax({
           type: "POST",
           url: "InvoiceDeliveryChallanList.aspx/GetPendingCase",
           contentType: "application/json; charset=utf-8",
    ...
    <script>
        ...
        function onPrintJv(id, TransDate) {
            ...
            if (ActiveEInvoice == "1")
            {
                ...
                if ((new Date(+dateParts[2], dateParts[1] - 1, +dateParts[0])) >= (new Date("01-01-2021"))) 
                {
                    $.ajax({
                        type: "POST",
                        url: "InvoiceDeliveryChallanList.aspx/GetEditablePermissionFromEInvoice",
        ...
        function OnclickViewAttachment(obj) {
            ...
            var URL = '/OMS/Management/Activities/EntriesDocuments.aspx?idbldng=' + obj + '&type=InvDelvChallan';
        ...
        function OnAddButtonClick() {
            var url = 'InvoiceDeliveryChallan.aspx?key=' + 'ADD';
            window.location.href = url;
        }

        function OnAddInventoryButtonClick() {
            var url = 'InvoiceDeliveryChallan.aspx?key=' + 'ADD&&InvType=I';
            window.location.href = url;
        }

        function OnAddNonInventoryButtonClick() {
            var url = 'InvoiceDeliveryChallan.aspx?key=' + 'ADD&&InvType=N';
            window.location.href = url;
        }

        function OnAddSeriviceButtonClick() {
            var url = 'InvoiceDeliveryChallan.aspx?key=' + 'ADD&&InvType=S';
            window.location.href = url;
        }

        function OnAddCapitalButtonClick() {
            var url = 'InvoiceDeliveryChallan.aspx?key=' + 'ADD&&InvType=C';
            window.location.href = url;
        }
        function OnAddBothButtonClick() {
            var url = 'InvoiceDeliveryChallan.aspx?key=' + 'ADD&&InvType=B';
            window.location.href = url;
        }
                        ...
                        success: function (msg) {
                            ...
                            if (status == "Yes") {
                                ...
                                if (ActiveUser != null) {
                                    $.ajax({
                                        type: "POST",
                                        url: "InvoiceDeliveryChallanList.aspx/GetEditablePermission",
                                        data: "{'ActiveUser':'" + ActiveUser + "'}",
                                        contentType: "application/json; charset=utf-8",
                                        dataType: "json",
                                        success: function (msg) {
                                            var status = msg.d;
                                            var url = 'InvoiceDeliveryChallan.aspx?key=' + keyValue + '&Permission=' + status + '&type=SI';
                                            window.location.href = url;
                                        }
                                    });
                                }
        ...
        function OnViewClick(keyValue) {
            ...
            cInvPosView.SetContentUrl(url);
            cInvPosView.RefreshContentUrl();
    ...
    <script type="text/javascript">
     ...
     <script>
         ...
         function InsertTransporterControlDetails(data) {
             ...
             $.ajax({
                 type: "POST",
                 url: "InvoiceDeliveryChallanList.aspx/InsertTransporterControlDetails",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="GridViewArea relative">
        <dxe:ASPxGridView ID="GrdQuotation" runat="server" KeyFieldName="INVOICE_ID" AutoGenerateColumns="False" SettingsBehavior-AllowFocusedRow="true"
            ...
            <Columns>
                ...
                <dxe:GridViewDataTextColumn Caption="Remarks" FieldName="REMARKS" VisibleIndex="16" Width="100px">
                  ...
                  <dxe:GridViewDataTextColumn Caption="IRN ?" FieldName="IsINR" VisibleIndex="17" Width="100px">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AllowAutoFilterTextInputTimer="False" />
                    <Settings AutoFilterCondition="Contains" />
                ...
                <dxe:GridViewDataTextColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="center" VisibleIndex="21" Width="0">
                    <DataItemTemplate>
            ...
            <SettingsPager NumericButtonCount="10" PageSize="10" ShowSeparators="True" Mode="ShowPager">
             ...
             <SettingsCookies Enabled="true" StorePaging="true" Version="2.2" />
            <GroupSummary>
        ...
        <dx:LinqServerModeDataSource ID="EntityServerModeDataSource" runat="server" OnSelecting="EntityServerModeDataSource_Selecting"
            ContextTypeName="ERPDataClassesDataContext" TableName="InvoiceChallanList" />
                ...
                <div class="row">
                    <div class="col-md-12">
                        <dxe:ASPxGridView ID="gridApprovedSO" runat="server" KeyFieldName="Order_Id" AutoGenerateColumns="False" OnDataBinding="gridApprovedSO_DataBinding"
                            ...
                            <SettingsPager NumericButtonCount="5" PageSize="7" ShowSeparators="True">
                                <FirstPageButton Visible="True">
                                </FirstPageButton>
                                <LastPageButton Visible="True">
                                </LastPageButton>
    ...
    <dxe:ASPxPopupControl ID="PosView" runat="server"
        CloseAction="CloseButton" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" ClientInstanceName="cInvPosView" Height="650px"
        Width="1020px" HeaderText="Sales Invoice Cum Challan" Modal="true">
