...
{
    public partial class CustomerReceiptAdjustment : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack) 
            {
                ...
                else
                {
                    ...
                    DataTable dtposTime = oDBEngine.GetDataTable("SELECT  top 1 convert(varchar(50),Lock_Fromdate,110) LockCon_Fromdate,convert(varchar(50),Lock_Todate,110) LockCon_Todate,convert(varchar(10),Lock_Fromdate,105) DataFreeze_Fromdate,convert(varchar(10),Lock_Todate,105) DataFreeze_Todate FROM Trans_LockConfigouration_Details WHERE  Type='Add' and Module_Id=57");
        ...
        private void AddmodeExecuted()
        {
            ...
            DataSet allDetails = blLayer.PopulateCustomerReceiptAdjustmentDetails();
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            blLayer.AddEditAdvanceAdjustment(hdAddEdit.Value,CmbScheme.Value.ToString().Split('~')[0],txtVoucherNo.Text,dtTDate.Date.ToString("yyyy-MM-dd"),
                ...
                ref adjustmentNumber, AdjustmentTable, ref ErrorCode, Request.QueryString["Key"], hdAdjustmentType.Value, hddnProjectId.Value);
            if (adjustmentId > 0)
            {
