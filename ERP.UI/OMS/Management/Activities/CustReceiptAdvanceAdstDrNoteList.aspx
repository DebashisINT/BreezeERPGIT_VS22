...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        function OnAddClick() {
            window.location.href = 'CustReceiptAdvanceAdstDrNote.aspx?Key=Add';
        }
    ...
    <script>
        ...
        function AllControlInitilize() {
            if (isFirstTime) {
                ...
                if (localStorage.getItem('AdvanceAdjDrNoteFromDate')) {
                    var fromdatearray = localStorage.getItem('AdvanceAdjDrNoteFromDate').split('-');
                    var fromdate = new Date(fromdatearray[0], parseFloat(fromdatearray[1]) - 1, fromdatearray[2], 0, 0, 0, 0);
                    cFormDate.SetDate(fromdate);
                }

                if (localStorage.getItem('AdvanceAdjDrNoteToDate')) {
                    var todatearray = localStorage.getItem('AdvanceAdjDrNoteToDate').split('-');
                    var todate = new Date(todatearray[0], parseFloat(todatearray[1]) - 1, todatearray[2], 0, 0, 0, 0);
                    ctoDate.SetDate(todate);
                }
                if (localStorage.getItem('AdvanceAdjDrNoteListBranch')) {
                    if (ccmbBranchfilter.FindItemByValue(localStorage.getItem('AdvanceAdjDrNoteListBranch'))) {
                        ccmbBranchfilter.SetValue(localStorage.getItem('AdvanceAdjDrNoteListBranch'));
                    }
        ...
        function OnViewClick(keyValue) {
            var url = 'CustReceiptAdvanceAdstDrNote.aspx?key=' + keyValue +'&req=V';
            window.location.href = url;
        }

        function onEditClick(id) {
            window.location.href = 'CustReceiptAdvanceAdstDrNote.aspx?Key=' + id;
        }
        ...
        function updateGridByDate() {
            ...
            if (cFormDate.GetDate() == null) {
                ...
                localStorage.setItem("AdvanceAdjDrNoteFromDate", cFormDate.GetDate().format('yyyy-MM-dd'));
                localStorage.setItem("AdvanceAdjDrNoteToDate", ctoDate.GetDate().format('yyyy-MM-dd'));
                localStorage.setItem("AdvanceAdjDrNoteListBranch", ccmbBranchfilter.GetValue());
    ...
    <link href="CSS/CustReceiptAdvanceAdstDrNoteList.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        <div class="panel-title clearfix">
            <h3 class="pull-left">Adjustment of Documents - Advance With Debit Note</h3>
        </div>
    </div>
    <table class="padTab">
        <tr>
...
<SettingsSearchPanel Visible="True" Delay="5000" />
            ...
            <dx:LinqServerModeDataSource ID="EntityServerModeDataSource" runat="server" OnSelecting="EntityServerModeDataSource_Selecting"
                ContextTypeName="ERPDataClassesDataContext" TableName="v_AdvanceAdjustmentWithDrNotes" />
