...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="" id="divSubmitButton">
                                                ...
                                                <span id="tdSaveButton" runat="server">
                                                    <dxe:ASPxButton ID="ASPxButton2" ClientInstanceName="cbtn_SaveRecords_p" runat="server" AutoPostBack="False" Text="Save & Ex&#818;it" CssClass="btn btn-success" meta:resourcekey="btnSaveRecordsResource1" UseSubmitBehavior="False">
    ...
    <!-- Modal -->
    <div class="modal fade pmsModal w40" id="exampleModalSRM" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
