    ...
    <script>
        ...
        function AllControlInitilize() {
            if (isFirstTime) {
                ...
                if (localStorage.getItem('VendorAdvanceAdjFromDate')) {
                    var fromdatearray = localStorage.getItem('VendorAdvanceAdjFromDate').split('-');
                    var fromdate = new Date(fromdatearray[0], parseFloat(fromdatearray[1]) - 1, fromdatearray[2], 0, 0, 0, 0);
                    cFormDate.SetDate(fromdate);
                }

                if (localStorage.getItem('VendorAdvanceAdjToDate')) {
                    var todatearray = localStorage.getItem('VendorAdvanceAdjToDate').split('-');
                    var todate = new Date(todatearray[0], parseFloat(todatearray[1]) - 1, todatearray[2], 0, 0, 0, 0);
                    ctoDate.SetDate(todate);
                }
                if (localStorage.getItem('VendorAdvanceAdjListBranch')) {
                    if (ccmbBranchfilter.FindItemByValue(localStorage.getItem('VendorAdvanceAdjListBranch'))) {
                        ccmbBranchfilter.SetValue(localStorage.getItem('VendorAdvanceAdjListBranch'));
                    }
        ...
        function onEditClick(id) {
            window.location.href = 'VendorPaymentAdjustment.aspx?Key=' + id;
        }
        ...
        function updateGridByDate() {
            ...
            if (cFormDate.GetDate() == null) {
                ...
                localStorage.setItem("VendorAdvanceAdjFromDate", cFormDate.GetDate().format('yyyy-MM-dd'));
                localStorage.setItem("VendorAdvanceAdjToDate", ctoDate.GetDate().format('yyyy-MM-dd'));
                localStorage.setItem("VendorAdvanceAdjListBranch", ccmbBranchfilter.GetValue());
        ...
        function OnAddClick() {
            window.location.href = 'VendorPaymentAdjustment.aspx?Key=Add';
        }
    ...
    <div class="outer-div-main clearfix">
        ...
        <div class="GridViewArea relative">
            ...
            <dxe:ASPxGridView ID="gridAdvanceAdj" runat="server" KeyFieldName="Adj_id" AutoGenerateColumns="False"
                ...
                SettingsBehavior-AllowSelectSingleRowOnly="false" SettingsBehavior-AllowSelectByRowClick="true" Settings-HorizontalScrollBarMode="Auto" Settings-VerticalScrollableHeight="280" Settings-VerticalScrollBarMode="Auto"
            ...
            <dx:LinqServerModeDataSource ID="EntityServerModeDataSource" runat="server" OnSelecting="EntityServerModeDataSource_Selecting"
                ContextTypeName="ERPDataClassesDataContext" TableName="v_VendorAdvanceAdjustment" />
