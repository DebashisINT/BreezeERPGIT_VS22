...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main clearfix">
        ...
        <div id="ApprovalCross" runat="server" class="crossBtn"><a href="VendorPaymentAdjustmentList.aspx"><i class="fa fa-times"></i></a></div>
    ...
    <div class="modal fade" id="AdvanceModel" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Advance Payment Search</h4>
                </div>
                <div class="modal-body">
