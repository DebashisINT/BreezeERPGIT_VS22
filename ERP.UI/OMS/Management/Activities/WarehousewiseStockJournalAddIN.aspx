...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   ...
   <%-- Rev 1.0 End--%>
    ...
    <style type="text/css">
        ...
        /*#gridDEstination_DXMainTable > tbody > tr > td:nth-child(18), #gridDEstination_DXMainTable > tbody > tr > td:nth-child(4) {
            display: none !important;
        }*/
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-title clearfix" id="myDiv">
        <h3 class="pull-left">
            <asp:Label ID="lblHeading" runat="server" Text="Add Warehouse Wise Stock - IN"></asp:Label>
        </h3>
    ...
    <div id="ApprovalCross" runat="server" class="crossBtn"><a href="WarehousewiseStockJournalListIN.aspx"><i class="fa fa-times"></i></a></div>
    <div class="form_main">
        ...
        <div class="boxBorder">
                    ...
                    <div class="makeFullscreen ">
                        ...
                        <dxe:ASPxGridView runat="server" OnBatchUpdate="gridDEstination_BatchUpdate" KeyFieldName="ActualDestSL" ClientInstanceName="gridDEstination" ID="gridDEstination"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataButtonEditColumn FieldName="ProductNameDest" Caption="Product" VisibleIndex="2" Width="160px" ReadOnly="True">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="DestProductID" Caption="" VisibleIndex="23" ReadOnly="True" Width="0" EditCellStyle-CssClass="hide"
                                ...
                                <dxe:GridViewDataTextColumn FieldName="DestDiscription" Caption="Description" VisibleIndex="3" Width="30%" ReadOnly="true">
                                    <CellStyle Wrap="True"></CellStyle>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataButtonEditColumn FieldName="DestinationWarehouse" Caption="Destination Warehouse" VisibleIndex="4" Width="160px" ReadOnly="True">
                                    <PropertiesButtonEdit>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="DestinationWarehouseID" Caption="" VisibleIndex="22" ReadOnly="True" Width="0" EditCellStyle-CssClass="hide"
                                    PropertiesTextEdit-FocusedStyle-CssClass="hide" PropertiesTextEdit-Style-CssClass="hide" PropertiesTextEdit-Height="15px">
                                    <CellStyle Wrap="True" CssClass="hide"></CellStyle>
                                </dxe:GridViewDataTextColumn>
            ...
            <div class="clear"></div>
            <h4 style="font-size: 14px;" class="hide">Stock Out</h4>
                    ...
                    <div class="makeFullscreen ">
                        ...
                        <dxe:ASPxGridView runat="server" OnBatchUpdate="grid_BatchUpdate" KeyFieldName="ActualSL" ClientInstanceName="grid" ID="grid"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataButtonEditColumn FieldName="ProductName" Caption="Product" VisibleIndex="2" Width="15%" ReadOnly="True">
                                    <PropertiesButtonEdit>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="EntityID" Caption="hidden Field Id" CellStyle-CssClass="hideContent" ReadOnly="True"
                                    Width="0" EditCellStyle-CssClass="hide" PropertiesTextEdit-FocusedStyle-CssClass="hide" PropertiesTextEdit-Style-CssClass="hide"
                                    PropertiesTextEdit-Height="15px">
                                    <CellStyle Wrap="True" CssClass="hide"></CellStyle>
                                </dxe:GridViewDataTextColumn>
                            ...
                            <div class="clearfix  row">
                                ...
                                <div class="col-md-3" id="_div_Manufacture">
                                    ...
                                    <div class="Left_Content" style="">
                                        ...
                                        <dxe:ASPxDateEdit ID="ASPxDateEdit1" runat="server" Width="100%" EditFormat="custom" UseMaskBehavior="True"
                                    ...
                                    <div class="Left_Content" style="">
                                        <dxe:ASPxTextBox ID="txtQty" runat="server" ClientInstanceName="ctxtQty" HorizontalAlign="Right" Font-Size="12px" Width="100%" Height="15px">
                                           ...
                                           <%-- <ClientSideEvents TextChanged="function(s, e) {SubmitWarehouse();}" LostFocus="ConversionFromUomToAltQuantity" />--%>
                                             <ClientSideEvents  LostFocus="ConversionFromUomToAltQuantity" />
                                            <ValidationSettings Display="None"></ValidationSettings>
                                        </dxe:ASPxTextBox>
    ...
    <asp:HiddenField ID="hdnRateRequiredStockIN" runat="server" />
