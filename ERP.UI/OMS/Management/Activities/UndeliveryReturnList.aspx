...
1.0                13-04-2023        2.0.37           Pallab              25816: Undelivery Return page design modification
====================================================== Revision History =============================================--%>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UndeliveryReturnList.aspx.cs" MasterPageFile="~/OMS/MasterPage/ERP.Master" Inherits="ERP.OMS.Management.Activities.UndeliveryReturnList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        function OnclickViewAttachment(obj) {
            ...
            var URL = '/OMS/Management/Activities/EntriesDocuments.aspx?idbldng=' + obj + '&type=UndeliveryReturn';
        ...
        function OnAddButtonClick() {
            var url = 'UndeliveryReturn.aspx?key=' + 'ADD';
            window.location.href = url;
        }
        ...
        function OnMoreInfoClick(keyValue) {
            ...
            //    $.ajax({
            //        type: "POST",
            //        url: "UndeliveryReturnList.aspx/GetEditablePermission",
            //        data: "{'ActiveUser':'" + ActiveUser + "'}",
            //        contentType: "application/json; charset=utf-8",
            //        dataType: "json",
            //        success: function (msg) {
            //            var status = msg.d;
            //            var url = 'UndeliveryReturn.aspx?key=' + keyValue + '&Permission=' + status + '&type=USR';
            //            window.location.href = url;
            //        }
            //    });
            //}
            ...
            if (ActiveUser != null) {
                ...
                $.ajax({
                    type: "POST",
                    url: "UndeliveryReturnList.aspx/GetReturnIdIsExistPosAdjustment",
                        ...
                        if (status == "1") {
                            jAlert('Already Adjusted.You can only view !', 'Confirmation Dialog', function (r) {
                                if (r == true) {
                                    ...
                                    var url = 'UndeliveryReturn.aspx?key=' + keyValue + '&req=A' + '&type=USR';
                                    window.location.href = url;
        ...
        function OnViewClick(keyValue) {
            var url = 'UndeliveryReturn.aspx?key=' + keyValue + '&req=V' + '&type=USR';
            window.location.href = url;
        }
        ...
        <dxe:ASPxGridView ID="GrdSalesReturn" ClientInstanceName="cGrdSalesReturn" runat="server" KeyFieldName="SrlNo"
           ...
           <SettingsSearchPanel Visible="True" Delay="5000" />
             <Columns>
                ...
                <dxe:GridViewDataTextColumn VisibleIndex="8" Caption="Assigned To Unit" FieldName="branchToBranch" Width="130px" Visible="false">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                    <Settings AllowAutoFilterTextInputTimer="False" />
                </dxe:GridViewDataTextColumn>
         ...
         <dx:LinqServerModeDataSource ID="EntityServerModeDataSource" runat="server" OnSelecting="EntityServerModeDataSource_Selecting"
            ContextTypeName="ERPDataClassesDataContext" TableName="v_UndeliveryReturnList" />
