...
<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="AdjustmentDetail_Customer.aspx.cs" Inherits="Reports.Reports.GridReports.AdjustmentDetail_Customer" %>
  ...
  <%-- For multiselection when click on ok button--%>
   <%-- For multiselection--%>
    ...
    <script type="text/javascript">
        ...
        function OpenAdjDocCustDetails(Uniqueid, type) {
            if (type == 'POS') {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                       ...
                       <div>
                           <dxe:ASPxGridView runat="server" ID="ShowGridList" ClientInstanceName="GridList" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="PARTYNAME" Caption="Customer Name" Width="300px" VisibleIndex="2" FixedStyle="Left">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                     <HeaderStyle HorizontalAlign="Left" />
                                </dxe:GridViewDataTextColumn>
                                 ...
                                 <dxe:GridViewDataTextColumn VisibleIndex="3" FieldName="DOC_NO" Width="140px" Caption="Doc. No." FixedStyle="Left">
                                    ...
                                    <DataItemTemplate>
                                        <a href="javascript:void(0)" onclick="OpenAdjDocCustDetails('<%#Eval("DOC_ID") %>','<%#Eval("DOC_TYPE") %>')">
                                            <%#Eval("DOC_NO")%>
                                        </a>
                                    </DataItemTemplate>
   ...
   <!--Customer Modal -->
    ...
    <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
            <asp:HiddenField ID="hfIsAdjDocCustFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
