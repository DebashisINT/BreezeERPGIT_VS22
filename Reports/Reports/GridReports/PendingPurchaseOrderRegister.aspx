...
<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="PendingPurchaseOrderRegister.aspx.cs" Inherits="Reports.Reports.GridReports.PendingPurchaseOrderRegister" %>
   ...
   <%-- For multiselection--%>
    ...
    <script type="text/javascript">
        function btn_ShowRecordsClick(e) {
            ...
            $("#hfIsPendPurchaseOrdRegFilter").val("Y");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main">
        ...
        <div class="row">
            ...
            <div class="col-md-2" id="divProj" style="margin-bottom:15px">
                <div style="color: #b5285f; font-weight: bold;" class="clsTo">
             ...
             <div class="col-md-2" style="padding-top:22px">
                <%--<div id="ckpar" style="padding-left: 5px">--%>
                <%--<div id="ckpar">
                    <asp:CheckBox runat="server" ID="ConsIPO" style="color: #b5285f" Text="Consider Import Purchase" />
                </div>--%>
                 <dxe:ASPxCheckBox runat="server" ID="ConsIPO" Checked="false" Text="Consider Import Purchase"></dxe:ASPxCheckBox>
            </div>
                       ...
                       <div>
                           <dxe:ASPxGridView runat="server" ID="ShowGridList" ClientInstanceName="GridList" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="1" FieldName="BRANCH_DESCRIPTION" Width="200px" Caption="Unit" >
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="2" FieldName="ORDER_NUMBER" Width="130px" Caption="Order Number" >
                                    ...
                                    <DataItemTemplate>
                                        <%--<a href="javascript:void(0)" target="_blank" onclick="OpenPendPurchaseOrdDetails('<%#Eval("ORDER_ID") %>','PO')">
                                            <%#Eval("ORDER_NUMBER")%>
                                        </a>--%>
                                        <a href="javascript:void(0)" onclick="OpenPendPurchaseOrdDetails('<%#Eval("ORDER_ID") %>','<%#Eval("MODULETYPE") %>')">
                                            <%#Eval("ORDER_NUMBER")%>
                                        </a>
                                    </DataItemTemplate>
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="4" FieldName="IMPORTPURCHASE" Width="80px" Caption="Imp. Purc." >
                                     <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>
                               
                                <dxe:GridViewDataTextColumn Caption="Vendor Name" FieldName="CUSTVEND_NAME" Width="310px" VisibleIndex="5" >
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                     <HeaderStyle HorizontalAlign="Left" />
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Product Code" FieldName="SHORTNAME" Width="200px"
                                    VisibleIndex="7" >
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                
                                <dxe:GridViewDataTextColumn Caption="Description" FieldName="SPRODUCTS_NAME" Width="240px"
                                    VisibleIndex="8" >
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Rate" FieldName="SALEPRICE" Width="110px"
                                    VisibleIndex="10" >
                            ...
                            <TotalSummary>
                                <dxe:ASPxSummaryItem FieldName="CUSTVEND_NAME" SummaryType="Custom" />
    ...
    <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
            <asp:HiddenField ID="hfIsPendPurchaseOrdRegFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
