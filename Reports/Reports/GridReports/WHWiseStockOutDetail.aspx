   ...
   <%-- For Brand multiselection--%> 
    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick(e) {
            ...
            if (gridbranchLookup.GetValue() == null) {
            ...
            else if (gridwarehouseLookup.GetValue() == null) {
                ...
                else if (gridbranchLookup.GetValue() == null) {
                    jAlert('Please select atleast one branch for generate the report.');
                }
                else if (gridwarehouseLookup.GetValue() == null) {
                    jAlert('Please select atleast one Warehouse for generate the report.');
        ...
        function OpenDetailsDocuments(Doc_ID, TransType) {
            if (TransType == 'WHSJOUT') {
                url = '/OMS/Management/Activities/WarehousewiseStockJournalAddOUT.aspx?key=' + Doc_ID + '&IsTagged=1&req=V&type=' + TransType;
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main">
        ...
        <div class="clearfix row">
           ...
           <div class="col-md-2" style="margin-top: 7px;">
            ...
            <div class="col-md-2 lblmTop8" style="margin-top:10px;margin-bottom: 8px" id="divProj" >
                                        ...
                                        <StatusBar>
                                            <table class="OptionsTable" style="float: right">
                                                <tr>
                                                    <td>
                                                        <%--<div class="hide">--%>
                                                            <dxe:ASPxButton ID="ASPxButton6" runat="server" AutoPostBack="false" Text="Select All" ClientSideEvents-Click="selectAll_Project" UseSubmitBehavior="False"/>
                                                        <%--</div>--%>
                                                        <dxe:ASPxButton ID="ASPxButton7" runat="server" AutoPostBack="false" Text="Deselect All" ClientSideEvents-Click="unselectAll_Project" UseSubmitBehavior="False"/>                                                        
                                                        <dxe:ASPxButton ID="ASPxButton8" runat="server" AutoPostBack="false" Text="Close" ClientSideEvents-Click="CloseGridProjectLookup" UseSubmitBehavior="False" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </StatusBar>
            ...
            <div class="col-md-2  pb-5" style="margin-top: 5px">
                    ...
                    <div>
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SEQ"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="DOCUMENT_NO" Width="150px" Caption="Document No" VisibleIndex="4" HeaderStyle-CssClass="colDisable">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="DOCUMENT_DATE" Width="100px" Caption="Date" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy" VisibleIndex="5" HeaderStyle-CssClass="colDisable">
                                    <CellStyle CssClass="gridcellleft" Wrap="true"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="HREMARKS" Width="220px" Caption="Header-Remarks" VisibleIndex="6" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="HREFNO" Width="120px" Caption="Header-Ref. No." VisibleIndex="7" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="PARTY" Width="220px" Caption="Customer" VisibleIndex="8" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="EMPNAME" Width="220px" Caption="Employee" VisibleIndex="9" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="HENTITYCODE" Width="120px" Caption="Header-Entity Code" VisibleIndex="10" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="HENTITYNAME" Width="220px" Caption="Header-Entity" VisibleIndex="11" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="DENTITYNAME" Width="220px" Caption="Line-Entity" VisibleIndex="14" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="TRANSPORTATIONMODE" Width="120px" Caption="Transportation Mode" VisibleIndex="15" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="VEHICLENO" Width="120px" Caption="Vehicle No." VisibleIndex="16" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="DETAILSREMARKS" Width="220px" Caption="Line-Remarks" VisibleIndex="17" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="DREFNO" Width="120px" Caption="Line-Ref No." VisibleIndex="18" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="PRODCODE" Width="200px" Caption="Product Code" VisibleIndex="19" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="PRODNAME" Width="200px" Caption="Product Name" VisibleIndex="20" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                                                                 
                                <dxe:GridViewDataTextColumn FieldName="PRODCLASS" Width="150px" Caption="Class" VisibleIndex="21" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="BRAND" Width="150px" Caption="Brand" VisibleIndex="22" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="STOCKUOM" Width="90px" Caption="Stock Unit" VisibleIndex="23" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="QUANTITY" Width="90px" Caption="Qty." VisibleIndex="24" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.0000;" HeaderStyle-CssClass="colDisable">
                                    <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="RATE" Width="90px" Caption="Rate" VisibleIndex="25" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.0000;" HeaderStyle-CssClass="colDisable">
                                    <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="AMOUNT" Width="90px" Caption="Amount" VisibleIndex="26" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.0000;" HeaderStyle-CssClass="colDisable">
                                     <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="ENTEREDBY" Width="120px" Caption="Entered By" VisibleIndex="27">
                                    <CellStyle CssClass="gridcellleft" Wrap="true"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="ENTEREDON" Width="100px" Caption="Entered On" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy" VisibleIndex="28" HeaderStyle-CssClass="colDisable">
                                    <CellStyle CssClass="gridcellleft" Wrap="true"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="UPDATEDBY" Width="120px" Caption="Updated By" VisibleIndex="29">
                                    <CellStyle CssClass="gridcellleft" Wrap="true"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="UPDATEDON" Width="100px" Caption="Updated On" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy" VisibleIndex="30" HeaderStyle-CssClass="colDisable">
                                    <CellStyle CssClass="gridcellleft" Wrap="true"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="EWAYBILLNUMBER" Width="90px" Caption="E-Way Bill No." VisibleIndex="31">
                                    <CellStyle CssClass="gridcellleft" Wrap="true"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="EWAYBILLDATE" Width="90px" Caption="E-Way Bill Date" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy" VisibleIndex="32" HeaderStyle-CssClass="colDisable">
                                    <CellStyle CssClass="gridcellleft" Wrap="true"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                            ...
                            <TotalSummary>
                                <dxe:ASPxSummaryItem FieldName="BRANCHDESC" SummaryType="Custom" Tag="BranchDesc"/>
                                <dxe:ASPxSummaryItem FieldName="QUANTITY" SummaryType="Custom" Tag="Item_Qty"/>
                                <dxe:ASPxSummaryItem FieldName="AMOUNT" SummaryType="Custom" Tag="Item_Amount"/>
                            </TotalSummary>
                        </dxe:ASPxGridView>
                            <dx:LinqServerModeDataSource ID="GenerateEntityServerModeDataSource" runat="server" OnSelecting="GenerateEntityServerModeDataSource_Selecting"
                        ContextTypeName="ReportSourceDataContext" TableName="WAREHOUSEWISESTOCKOUTDETAILS_REPORT" ></dx:LinqServerModeDataSource>
    ...
    <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
            <asp:HiddenField ID="hfIsWHWiseStkDetFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
