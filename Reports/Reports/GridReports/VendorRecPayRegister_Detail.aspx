...
<%@ Page Title="" Language="C#"  MasterPageFile="~/OMS/MasterPage/ERP.Master"  AutoEventWireup="true" CodeBehind="VendorRecPayRegister_Detail.aspx.cs" 
    Inherits="Reports.Reports.GridReports.VendorRecPayRegister_Detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div style="padding-left: 15px;padding-top:24px;">
                    ...
                    <div>
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SRLNO" 
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="BRANCHNAME" Caption="Unit" VisibleIndex="2" Width="160px"/>
                                <dxe:GridViewDataTextColumn FieldName="RECEIPTPAYMENT_TRANSACTIONTYPE" Caption="Voucher Type" Width="100px" VisibleIndex="3" />
                                <dxe:GridViewDataTextColumn FieldName="RECEIPTPAYMENT_VOUCHERNUMBER" Caption="Voucher No." Width="150px" VisibleIndex="4">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="PARTYNAME" Caption="Vendor(s)" VisibleIndex="6" Width="200px"/>
                                <dxe:GridViewDataTextColumn FieldName="PROJ_NAME" Caption="Project Name" VisibleIndex="7" Width="150px"/>
                                <dxe:GridViewDataTextColumn FieldName="CASHBANK_NAME" Caption="Cash/Bank" VisibleIndex="8" Width="200px"/>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="TRAN_TYPE" Caption="Doc. Type" VisibleIndex="12" Width="100px"/>
                                <dxe:GridViewDataTextColumn FieldName="DOC_NO" Caption="Doc. No." VisibleIndex="13" Width="160px"/>
                                <dxe:GridViewDataTextColumn FieldName="DOC_DATE" Caption="Doc. Date" Width="160px" VisibleIndex="14" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy" />
                                <dxe:GridViewDataTextColumn FieldName="REAMRKS" Caption="Remarks" VisibleIndex="15" Width="200px"/>
                                <dxe:GridViewDataTextColumn FieldName="TAXABLE_AMOUNT" Caption="Taxable" VisibleIndex="16" PropertiesTextEdit-DisplayFormatString="0.00" Width="100px">
    ...
    <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
            <asp:HiddenField ID="hfIsVendRecPayDetail" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
