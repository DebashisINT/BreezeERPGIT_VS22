...
2.0                27-04-2023        2.0.38           Pallab              25949 : Purchase Return Register - Detail module zoom popup upper part visible issue fix
====================================================== Revision History =============================================--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="PurchaseReturnRegister_Details.aspx.cs" Inherits="Reports.Reports.GridReports.PurchaseReturnRegister_Details" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick(e) {
            ...
            e.preventDefault;
            var data = "OnDateChanged";
            $("#hfIsPurchaseRetRegDetFilter").val("Y");
        ...
        function OpenPOSDetails(preturn, type) {
            if (type == 'PR') {
                url = '/OMS/Management/Activities/PReturn.aspx?key=' + preturn + '&IsTagged=1&req=V&type=PR';
            }
            else if (type == 'PRM') {
                url = '/OMS/Management/Activities/PurchaseReturnManual.aspx?key=' + preturn + '&IsTagged=1&req=V&type=PR';
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        <%--<div class="panel-title">
            <h3>Purchase Return Register - Detail </h3>
        </div>--%>
                ...
                <td colspan="2">
                    ...
                    <div>
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False"
                            ...
                            <Columns>
                               ...
                               <%-- <dxe:GridViewDataTextColumn FieldName="SLNO" Caption="Serial" Width="50px" VisibleIndex="0" FixedStyle="Left">
                                ...
                                <dxe:GridViewDataTextColumn Caption="Vendor Name" Width="200px" FieldName="VENDOR_NAME"
                                    VisibleIndex="2" FixedStyle="Left">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn VisibleIndex="3" FieldName="BILL_NO" Width="130px" Caption="Return No." FixedStyle="Left">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <DataItemTemplate>

                                        <a href="javascript:void(0)" onclick="OpenPOSDetails('<%#Eval("RETURN_ID") %>','<%#Eval("MODULE_TYPE") %>')">
                                            <%#Eval("BILL_NO")%>
                                        </a>
                                    </DataItemTemplate>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Return Date" Width="80px" FieldName="BILL_DATE"
                                    VisibleIndex="4">
                                    <PropertiesTextEdit DisplayFormatString="dd-MM-yyyy"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>
                                  <dxe:GridViewDataTextColumn Caption="Transaction Type" FieldName="MODULE_TYPE_DESC" Width="200px"
                                    VisibleIndex="5">
                                  </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="PURCHASEPRICE" Caption="Rate" Width="90px" VisibleIndex="7">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                     <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn FieldName="PURCHASE_VALUE" Caption="Purc. Value" Width="90px" VisibleIndex="8">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                     <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="TAX_MISC" Caption="Tax Misc." Width="90px" VisibleIndex="14">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                     <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn FieldName="TOTAL_VALUE" Caption="Total Value" Width="90px" VisibleIndex="15">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                     <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>
                            </Columns>
                            ...
                            <TotalSummary>
                                ...
                                <dxe:ASPxSummaryItem FieldName="PURCHASE_VALUE" SummaryType="Sum" />
                      ...
                      <dx:LinqServerModeDataSource ID="GenerateEntityServerModeDataSource" runat="server" OnSelecting="GenerateEntityServerModeDataSource_Selecting"
                            ContextTypeName="ReportSourceDataContext" TableName="PURCHASEREGISTERPRODUCTDETAILS_REPORT"></dx:LinqServerModeDataSource>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
            <asp:HiddenField ID="hfIsPurchaseRetRegDetFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
