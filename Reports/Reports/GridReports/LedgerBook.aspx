...
<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="LedgerBook.aspx.cs" Inherits="Reports.Reports.GridReports.LedgerBook" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        document.onkeyup = function (e) {
            if (event.keyCode == 27 && popupldgr.GetVisible() == true) { //run code for alt+N -- ie, Save & New  
                popupHide();
            }
        }
        ...
        function BindActivityType(noteTilte) {
            ...
            $.ajax({
                type: "POST",
                url: 'LedgerBook.aspx/GetBranchesList',
    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick(e) {
            ...
            //var grid = gridledgerLookup.GetGridView();
            //grid.GetRowValues(grid.GetFocusedRowIndex(), 'Doc Code', OnGetRowValues);
            ...
            else if (BranchSelection == "Yes" && gridbranchLookup.GetValue() == null && ctxtLedger.GetValue() != null) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-md-2">
                ...
                <div>
                    <dxe:ASPxDateEdit ID="ASPxFromDate" runat="server" EditFormat="custom" DisplayFormatString="dd-MM-yyyy" EditFormatString="dd-MM-yyyy"
                        UseMaskBehavior="True" Width="100%" ClientInstanceName="cxdeFromDate" TabIndex="3">
            ...
            <div class="col-md-2">
                    ...
                    <div>
                        <dxe:ASPxDateEdit ID="ASPxToDate" runat="server" EditFormat="custom" DisplayFormatString="dd-MM-yyyy" EditFormatString="dd-MM-yyyy"
                            UseMaskBehavior="True" Width="100%" ClientInstanceName="cxdeToDate" TabIndex="4">
                            <ButtonStyle Width="13px">
                            </ButtonStyle>
           ...
           <div class="hide">
                <div class="col-md-2">
                    <div id="ckpar" style="padding-top: 7px;">
                        <asp:CheckBox runat="server" ID="chkparty" Checked="false" Text="Consider Party Inv. Date" />
                    </div>
                </div>
           </div>
                    ...
                    <div onkeypress="OnWaitingGridKeyPress(event)">
                        ...
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyboardSupport="true" KeyFieldName="SEQ"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="MAINACCOUNT" Caption="Ledger Description" VisibleIndex="2" GroupIndex="0" HeaderStyle-CssClass="colDisable" />
                                <dxe:GridViewDataTextColumn VisibleIndex="3" FieldName="DOCUMENT_NO" Caption="Document No." Width="150px" HeaderStyle-CssClass="colDisable" >
                                ...
                                <dxe:GridViewDataTextColumn FieldName="TRAN_DATE" Caption="Date" Width="100px" VisibleIndex="4" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="TRAN_TYPE" Caption="Particular" Width="150px" VisibleIndex="6" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn FieldName="PAYEE_INFO" Caption="Payee/Party" Width="180px" VisibleIndex="7" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn FieldName="NARRATION" Caption="Header Narration" Width="180px" VisibleIndex="8" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                                 <dxe:GridViewDataTextColumn FieldName="OP_DR" Caption="Opening Dr." VisibleIndex="9" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" HeaderStyle-CssClass="colDisable" >
                                     <HeaderStyle HorizontalAlign="Right" />
                                 </dxe:GridViewDataTextColumn>
                                 <dxe:GridViewDataTextColumn FieldName="OP_CR" Caption="Opening Cr."   VisibleIndex="10" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" HeaderStyle-CssClass="colDisable" >
                                     <HeaderStyle HorizontalAlign="Right" />
                                 </dxe:GridViewDataTextColumn>
                                 <dxe:GridViewDataTextColumn FieldName="PR_DR" Caption="Period Dr."   VisibleIndex="11" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" HeaderStyle-CssClass="colDisable" >
                                     <HeaderStyle HorizontalAlign="Right" />
                                 </dxe:GridViewDataTextColumn>
                                 <dxe:GridViewDataTextColumn FieldName="PR_CR" Caption="Period Cr."  VisibleIndex="12" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" HeaderStyle-CssClass="colDisable" >
                                     <HeaderStyle HorizontalAlign="Right" />
                                 </dxe:GridViewDataTextColumn>
                                 <dxe:GridViewDataTextColumn FieldName="CL_DR" Caption="Closing Dr."  VisibleIndex="13" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" HeaderStyle-CssClass="colDisable" >
                                     <HeaderStyle HorizontalAlign="Right" />
                                 </dxe:GridViewDataTextColumn>
                                 <dxe:GridViewDataTextColumn FieldName="CL_CR" Caption="Closing Cr."  VisibleIndex="14" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" HeaderStyle-CssClass="colDisable" >
                                     <HeaderStyle HorizontalAlign="Right" />
                                 </dxe:GridViewDataTextColumn>
                            </Columns>
                            ...
                            <TotalSummary>
                                <dxe:ASPxSummaryItem FieldName="DOCUMENT_NO" SummaryType="Custom" Tag="Ledg_DocNo"/>
                                <dxe:ASPxSummaryItem FieldName="OP_DR" SummaryType="Sum" Tag="Ledg_OpDr"/>
                                <dxe:ASPxSummaryItem FieldName="OP_CR" SummaryType="Sum" Tag="Ledg_OpCr"/>
                                <dxe:ASPxSummaryItem FieldName="PR_DR" SummaryType="Sum" Tag="Ledg_PrDr"/>
                                <dxe:ASPxSummaryItem FieldName="PR_CR" SummaryType="Sum" Tag="Ledg_PrCr"/>
                                <dxe:ASPxSummaryItem FieldName="CL_DR" SummaryType="Custom" Tag="Ledg_ClDr"/>
                                <dxe:ASPxSummaryItem FieldName="CL_CR" SummaryType="Custom" Tag="Ledg_ClCr"/>
                            </TotalSummary>
                        </dxe:ASPxGridView>
                        <dx:LinqServerModeDataSource ID="GenerateEntityServerModeDataSource" runat="server" OnSelecting="GenerateEntityServerModeDataSource_Selecting"
                        ContextTypeName="ReportSourceDataContext" TableName="LEDGERBOOKRUNNINGBAL_REPORT"></dx:LinqServerModeDataSource>
                    </div>
                </td>
            </tr>
        </table>
   ...
   <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
    <PanelCollection>
        <dxe:PanelContent runat="server">
        <asp:HiddenField ID="hfIsLedgerBook" runat="server" />
        </dxe:PanelContent>
    </PanelCollection>
