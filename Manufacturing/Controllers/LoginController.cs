...
namespace Manufacturing.Controllers
{
    public class LoginController : Controller
    {
        ...
        {
            Session["ErpConnection"] = @"Data Source=3.7.30.86,1480\SQLEXPRESS;Initial Catalog=PASARI;User ID=sa; Password=5dc57YITWh";
            Encryption epasswrd = new Encryption();
            string Encryptpass = epasswrd.Encrypt(password);
            BusinessLogicLayer.DBEngine oDBEngine = new BusinessLogicLayer.DBEngine(@"Data Source=3.7.30.86,1480\SQLEXPRESS;Initial Catalog=PASARI;User ID=sa; Password=5dc57YITWh;pooling='true';Max Pool Size=200");
